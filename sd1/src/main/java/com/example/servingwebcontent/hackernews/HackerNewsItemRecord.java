...
public record HackerNewsItemRecord(
   ...
   public HackerNewsItemRecord(Integer id, Boolean deleted, String type, String by, Long time, String text, Boolean dead, String parent, Integer poll, List kids, Integer score, List parts,Integer descendants , String title, String url) {
        this(id, deleted, type, by, time, text, dead, parent, poll, kids, url, score, title, parts, descendants);
    }
